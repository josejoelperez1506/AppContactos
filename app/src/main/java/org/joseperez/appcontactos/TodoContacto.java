 ...
 */
public class TodoContacto extends CursorAdapter {
    public TodoContacto(Context context, Cursor cursor) {
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        TextView telefonotxt = (TextView) view.findViewById(R.id.telefono_txt);
